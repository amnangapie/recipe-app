package ua.nure.recipeapp.bootstrap;
...
import ua.nure.recipeapp.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        tacosRecipe.addIngredient(new Ingredient("finely grated orange zedra", new BigDecimal(1), tableSpoonUom));
